...
`hubuum_client` 0.11.1 targets Hubuum server v0.0.15. The pinned image,
...
```toml
[dependencies]
hubuum_client = { version = "0.11.1", default-features = false, features = ["blocking"] }
```
