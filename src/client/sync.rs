...
struct ClientRuntime {
    ...
    transport: Option<Arc<dyn super::transport::BlockingTransport>>,
    base_url: BaseUrl,
    options: shared::ClientOptions,
}

/// Blocking Hubuum client.
///
...
impl ClientBuilder {
    ...
    pub fn with_transport(
        mut self,
        transport: Arc<dyn super::transport::BlockingTransport>,
    ) -> Self {
...
impl<S> Client<S> {
    ...
    fn transport(&self) -> Option<&Arc<dyn super::transport::BlockingTransport>> {
...
impl Client<Authenticated> {
    ...
    fn patch_with_headers<R: ApiResource, I>(
        &self,
        resource: R,
        id: I,
        ...
        I: Into<R::Id>,
    {
        ...
        let raw = self.request_with_endpoint_raw_with_headers(
    ...
    fn delete_with_headers<R: ApiResource, I>(
        &self,
        resource: R,
        id: I,
        mut url_params: UrlParams,
    ...
    pub fn collection_history_as_of_full(
        &self,
        collection_id: impl Into<CollectionId>,
        at: HubuumDateTime,
...
impl PrincipalSettingsScope {
    ...
    pub fn get(&self) -> Result<PrincipalSettingsResponse, ApiError> {
        Ok(self.get_revisioned()?.into_inner())
    }

    pub fn get_revisioned(&self) -> Result<Revisioned<PrincipalSettingsResponse>, ApiError> {
        let raw = self
            .client
    ...
    pub fn replace<T>(&self, settings: &T) -> Result<PrincipalSettingsResponse, ApiError>
    where
        T: Serialize + ?Sized,
    {
    ...
    pub fn patch<T>(&self, patch: &T) -> Result<PrincipalSettingsResponse, ApiError>
    where
        T: Serialize + ?Sized,
    {
...
impl PersonalComputedFields {
    ...
    pub fn delete(&self, field_id: impl Into<ComputedFieldDefinitionId>) -> Result<(), ApiError> {
        let path = Endpoint::MeComputedFieldById
            .path()
            .replace("{field_id}", &field_id.into().to_string());
        self.client.raw(reqwest::Method::DELETE, path).execute()?;
        Ok(())
    }
...
impl<T: ApiResource> UpdateOp<T> {
    ...
    pub fn send(self) -> Result<T::PatchOutput, ApiError> {
        ...
        match self.if_match {
            Some(etag) => self.client.patch_with_headers::<T, _>(
                T::default(),
                self.id,
                self.url_params,
                self.params,
...
impl<T: ApiResource> Resource<T> {
    ...
    pub fn delete_if_match<I: Into<T::Id>>(
        &self,
        id: I,
        etag: &crate::types::EntityTag,
    ) -> Result<(), ApiError> {
        self.client.delete_with_headers::<T, _>(
            T::default(),
            id.into(),
            self.url_params.clone(),
            &[(reqwest::header::IF_MATCH.as_str(), etag.to_string())],
    ...
    T: ApiResource<GetOutput = T> + DeserializeOwned + GetID + Default + 'static,
{
    pub fn get<I: Into<T::Id>>(&self, id: I) -> Result<Handle<T>, ApiError> {
        ...
        if let Some(endpoint) = T::ITEM_ENDPOINT {
            ...
            match self.client.request_with_endpoint_raw(
                reqwest::Method::GET,
                &endpoint,
                url_params,
                vec![],
