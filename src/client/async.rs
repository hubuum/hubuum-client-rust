    ...
    pub async fn get(&self) -> Result<Handle<Class>, ApiError> {
        if shared::requires_name_route_fallback(&self.class_name) {
            let class_id = self
                ...
                .await?;
            return self.client.classes().get(class_id).await;
        }
    ...
    pub async fn get(&self) -> Result<Handle<Object>, ApiError> {
        if self.requires_fallback() {
            let (class_id, object_id) = self
                ...
                .await?;
            return self.client.objects(class_id).get(object_id).await;
        }
...
impl ClassSchema {
    ...
    pub async fn get(&self) -> Result<ClassSchemaResponse, ApiError> {
        let raw = self
            .client
            .request_with_endpoint_raw(
                reqwest::Method::GET,
    ...
    pub async fn impact(&self, revision: SchemaRevision) -> Result<SchemaWorkResponse, ApiError> {
        let raw = self
            .client
            .request_with_endpoint_raw(
                reqwest::Method::POST,
    ...
    pub async fn work(&self, task_id: impl Into<TaskId>) -> Result<SchemaWorkResponse, ApiError> {
        let raw = self
            .client
            .request_with_endpoint_raw(
                reqwest::Method::GET,
