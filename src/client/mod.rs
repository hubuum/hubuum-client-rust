...
mod parity_contract {
    ...
    macro_rules! assert_cursor_request_surface {
        ($module:ident) => {
            ...
            let _ = $module::TaskListRequest::class_id;
            let _ = $module::TaskListRequest::object_id;
            let _ = $module::TaskListRequest::collection_id;
            let _ = $module::TaskListRequest::schema_revision;
            let _ = $module::TaskListRequest::computation_revision;
            let _ = $module::TaskListRequest::schema_work_kind;
            let _ = $module::TaskListRequest::schema_work_status;
            let _ = $module::TaskListRequest::remote_target_id;
            let _ = $module::TaskListRequest::remote_side_effect_state;
            let _ = $module::TaskListRequest::export_scope_kind;
            let _ = $module::TaskListRequest::export_template_id;
            let _ = $module::TaskListRequest::export_has_warnings;
            let _ = $module::TaskListRequest::export_truncated;
            let _ = $module::TaskListRequest::import_dry_run;
            let _ = $module::TaskListRequest::import_atomicity;
            let _ = $module::TaskListRequest::import_collision_policy;
            let _ = $module::TaskListRequest::import_permission_policy;
            let _ = $module::TaskListRequest::import_has_failed_items;
            let _ = $module::TaskListRequest::backup_include_history;
            let _ = $module::TaskListRequest::output_state;
            let _ = $module::TaskListRequest::terminal;
            let _ = $module::TaskListRequest::cancel_requested;
            let _ = $module::TaskListRequest::terminal_reason;
            let _ = $module::TaskListRequest::trace_id;
            let _ = $module::TaskListRequest::created_after;
            let _ = $module::TaskListRequest::created_before;
            let _ = $module::TaskListRequest::started_after;
            let _ = $module::TaskListRequest::started_before;
            let _ = $module::TaskListRequest::finished_after;
            let _ = $module::TaskListRequest::finished_before;
            let _ = $module::TaskListRequest::class_relation;
            let _ = $module::TaskListRequest::object_relation;
            let _: fn($module::TaskListRequest, [crate::types::TaskKind; 2]) -> _ =
                $module::TaskListRequest::kinds;
            let _: fn($module::TaskListRequest, [crate::types::TaskStatus; 2]) -> _ =
                $module::TaskListRequest::statuses;
